# 0 "/Users/warren/Development/Embedded/ESP/esp-idf/components/esp_netif/esp_netif_defaults.c"
# 1 "/Users/warren/Development/Embedded/ESP/Projects/blinky/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/Users/warren/Development/Embedded/ESP/esp-idf/components/esp_netif/esp_netif_defaults.c"
...
# 8 "/Users/warren/Development/Embedded/ESP/esp-idf/components/esp_netif/esp_netif_defaults.c" 2
# 19 "/Users/warren/Development/Embedded/ESP/esp-idf/components/esp_netif/esp_netif_defaults.c"
const esp_netif_inherent_config_t _g_esp_netif_inherent_sta_config = { .flags = (esp_netif_flags_t)((ESP_NETIF_DHCP_CLIENT) | (ESP_NETIF_FLAG_GARP) | (ESP_NETIF_FLAG_MLDV6_REPORT) | ESP_NETIF_FLAG_EVENT_IP_MODIFIED | (0)), .get_ip_event = IP_EVENT_STA_GOT_IP, .lost_ip_event = IP_EVENT_STA_LOST_IP, .if_key = "WIFI_STA_DEF", .if_desc = "sta", .route_prio = 100, .bridge_info = 
# 19 "/Users/warren/Development/Embedded/ESP/esp-idf/components/esp_netif/esp_netif_defaults.c" 3 4
                                                                    ((void *)0) 
# 19 "/Users/warren/Development/Embedded/ESP/esp-idf/components/esp_netif/esp_netif_defaults.c"
                                                                    };
...
const esp_netif_ip_info_t _g_esp_netif_soft_ap_ip = {
        .ip = { .addr = (((((((uint32_t)((192) & 0xffU) << 24) | ((uint32_t)((168) & 0xffU) << 16) | ((uint32_t)((4) & 0xffU) << 8) | (uint32_t)((1) & 0xffU))) & (uint32_t)0x000000ffUL) << 24) | ((((((uint32_t)((192) & 0xffU) << 24) | ((uint32_t)((168) & 0xffU) << 16) | ((uint32_t)((4) & 0xffU) << 8) | (uint32_t)((1) & 0xffU))) & (uint32_t)0x0000ff00UL) << 8) | ((((((uint32_t)((192) & 0xffU) << 24) | ((uint32_t)((168) & 0xffU) << 16) | ((uint32_t)((4) & 0xffU) << 8) | (uint32_t)((1) & 0xffU))) & (uint32_t)0x00ff0000UL) >> 8) | ((((((uint32_t)((192) & 0xffU) << 24) | ((uint32_t)((168) & 0xffU) << 16) | ((uint32_t)((4) & 0xffU) << 8) | (uint32_t)((1) & 0xffU))) & (uint32_t)0xff000000UL) >> 24)) },
        .gw = { .addr = (((((((uint32_t)((192) & 0xffU) << 24) | ((uint32_t)((168) & 0xffU) << 16) | ((uint32_t)((4) & 0xffU) << 8) | (uint32_t)((1) & 0xffU))) & (uint32_t)0x000000ffUL) << 24) | ((((((uint32_t)((192) & 0xffU) << 24) | ((uint32_t)((168) & 0xffU) << 16) | ((uint32_t)((4) & 0xffU) << 8) | (uint32_t)((1) & 0xffU))) & (uint32_t)0x0000ff00UL) << 8) | ((((((uint32_t)((192) & 0xffU) << 24) | ((uint32_t)((168) & 0xffU) << 16) | ((uint32_t)((4) & 0xffU) << 8) | (uint32_t)((1) & 0xffU))) & (uint32_t)0x00ff0000UL) >> 8) | ((((((uint32_t)((192) & 0xffU) << 24) | ((uint32_t)((168) & 0xffU) << 16) | ((uint32_t)((4) & 0xffU) << 8) | (uint32_t)((1) & 0xffU))) & (uint32_t)0xff000000UL) >> 24)) },
        .netmask = { .addr = (((((((uint32_t)((255) & 0xffU) << 24) | ((uint32_t)((255) & 0xffU) << 16) | ((uint32_t)((255) & 0xffU) << 8) | (uint32_t)((0) & 0xffU))) & (uint32_t)0x000000ffUL) << 24) | ((((((uint32_t)((255) & 0xffU) << 24) | ((uint32_t)((255) & 0xffU) << 16) | ((uint32_t)((255) & 0xffU) << 8) | (uint32_t)((0) & 0xffU))) & (uint32_t)0x0000ff00UL) << 8) | ((((((uint32_t)((255) & 0xffU) << 24) | ((uint32_t)((255) & 0xffU) << 16) | ((uint32_t)((255) & 0xffU) << 8) | (uint32_t)((0) & 0xffU))) & (uint32_t)0x00ff0000UL) >> 8) | ((((((uint32_t)((255) & 0xffU) << 24) | ((uint32_t)((255) & 0xffU) << 16) | ((uint32_t)((255) & 0xffU) << 8) | (uint32_t)((0) & 0xffU))) & (uint32_t)0xff000000UL) >> 24)) },
};

const esp_netif_inherent_config_t _g_esp_netif_inherent_ap_config = { .flags = (esp_netif_flags_t)((ESP_NETIF_DHCP_SERVER) | ESP_NETIF_FLAG_AUTOUP), .ip_info = &_g_esp_netif_soft_ap_ip, .get_ip_event = 0, .lost_ip_event = 0, .if_key = "WIFI_AP_DEF", .if_desc = "ap", .route_prio = 10, .bridge_info = 
# 28 "/Users/warren/Development/Embedded/ESP/esp-idf/components/esp_netif/esp_netif_defaults.c" 3 4
                                                                   ((void *)0) 
# 28 "/Users/warren/Development/Embedded/ESP/esp-idf/components/esp_netif/esp_netif_defaults.c"
                                                                   };
...
const esp_netif_inherent_config_t _g_esp_netif_inherent_eth_config = { .flags = (esp_netif_flags_t)((ESP_NETIF_DHCP_CLIENT) | (ESP_NETIF_FLAG_GARP) | ESP_NETIF_FLAG_EVENT_IP_MODIFIED | (0)), .get_ip_event = IP_EVENT_ETH_GOT_IP, .lost_ip_event = IP_EVENT_ETH_LOST_IP, .if_key = "ETH_DEF", .if_desc = "eth", .route_prio = 50, .bridge_info = 
# 35 "/Users/warren/Development/Embedded/ESP/esp-idf/components/esp_netif/esp_netif_defaults.c" 3 4
                                                                    ((void *)0) 
# 35 "/Users/warren/Development/Embedded/ESP/esp-idf/components/esp_netif/esp_netif_defaults.c"
                                                                    };
